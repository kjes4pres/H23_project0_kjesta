...
@pytest.mark.parametrize("x, y, expected", [(1, 2, 3), (2, 2, 4), (1, 1, 2)])
...
@pytest.mark.parametrize("x, y, expected", [(2, 2, 1), (1, 0.5, 2), (0.1, 100, 0.001)])
...
@pytest.mark.parametrize("x, expected", [(0, 1), (2, 2), (5, 120)])
...
@pytest.mark.parametrize(
    "x, expected",
    [(0, 0), (np.pi / 4, 1 / (np.sqrt(2))), (np.pi / 2, 1), (3 * np.pi / 2, -1)],
)
